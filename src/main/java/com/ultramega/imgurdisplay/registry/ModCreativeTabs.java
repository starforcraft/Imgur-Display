...
public class ModCreativeTabs {
	...
	public static final Supplier<CreativeModeTab> TAB_DISPLAY = CREATIVE_MODE_TAB.register(ImgurDisplay.MODID, () -> CreativeModeTab.builder()
		.title(Component.translatable("itemGroup." + ImgurDisplay.MODID))
		.icon(() -> new ItemStack(ModItems.DISPLAY.get()))
